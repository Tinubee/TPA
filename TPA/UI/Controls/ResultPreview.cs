...
namespace TPA.UI.Controls
{
    public partial class ResultPreview : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void 검사완료알림(검사결과 결과)
        {
            ...
            SetValue(sedit바닥평면도, 결과.GetItem(검사항목.바닥평면도));
            SetValue(edit역투입, 결과.GetItem(검사항목.역투입), 결과.역투입여부);
            SetValue(edit각인, 결과.GetItem(검사항목.노멀미러), 결과.노멀미러);
            SetValue(sedit선윤곽도F, 결과.GetItem(검사항목.선윤곽도_F));
            SetValue(sedit선윤곽도H_F, 결과.GetItem(검사항목.선윤곽도H_F));
            SetValue(sedit선윤곽도H_R, 결과.GetItem(검사항목.선윤곽도H_R));
            SetValue(sedit선윤곽도J_F, 결과.GetItem(검사항목.선윤곽도J_F));
            SetValue(sedit선윤곽도J_R, 결과.GetItem(검사항목.선윤곽도J_R));
            ...
            SetValue(sedit커버들뜸, 결과.GetItem(검사항목.커버들뜸));
        }
