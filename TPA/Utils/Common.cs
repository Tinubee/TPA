...
namespace TPA.Schemas
{
    ...
    public static class Common
    {
        ...
        {
            return source.Resize(OpenCvSharp.Size.Zero, scale, scale, InterpolationFlags.Linear);
            //return source.Resize(new OpenCvSharp.Size(source.Width * scale, source.Height * scale));
        }
        ...
        public static CogImage8Grey LoadImage(String path)
        {
