    ...
    public partial class State : XtraUserControl
    {
        ...
        public void Init()
        {
            ...
            if (Global.환경설정.슈퍼유저) {
                 ...
                 this.e모델선택.Properties.ShowDropDown = DevExpress.XtraEditors.Controls.ShowDropDown.Never;
            this.e모델선택.CustomDisplayText += 선택모델표현;
        ...
        private void 동작상태알림()
        {
            ...
            this.b동작구분.Appearance.ForeColor = Global.장치통신.시작정지여부 ? DXSkinColors.ForeColors.Information : DXSkinColors.ForeColors.DisabledText;
        }
