...
{
    public partial class ResultPivot : XtraUserControl
    {
        public ResultPivot()
        {
            InitializeComponent();
        ...
        public void Init()
        {
            EnumToList 모델 = new EnumToList(typeof(모델구분));
            모델.SetLookUpEdit(this.e모델선택);
            this.e모델선택.EditValue = Global.환경설정.선택모델;
            this.e모델선택.CustomDisplayText += 모델선택_CustomDisplayText;
            ...
            foreach (장치구분 장치 in typeof(장치구분).GetEnumValues()) {
                ...
                GridBand band = new GridBand() { Caption = Utils.GetDescription(장치), VisibleIndex = (Int32)장치 };
        ...
        private GridBand GetBand(String Caption)
        {
            return this.GridView1.Bands.Where(g => g.Caption == Caption).FirstOrDefault();
        }
        ...
        private void LoadData(모델구분 모델, DateTime 시작, DateTime 종료)
        {
            ...
            foreach (BandedGridColumn gCol in this.GridView1.Columns) {
                ...
                gCol.Visible = this.검사내역.GetVisible(dCol);
        ...
        private void GridView1_CustomDrawFooterCell(object sender, DevExpress.XtraGrid.Views.Grid.FooterCellCustomDrawEventArgs e)
        {
            ...
            e.Info.DisplayText = Convert.ToString(e.Column.SummaryItem.Tag);
        ...
        private void 엑셀파일(object sender, EventArgs e)
        {
            ...
            //PrintingSystem.PageSettings.PaperKind = System.Drawing.Printing.PaperKind.A3Extra;
        ...
        {
            this.LoadData((모델구분)this.e모델선택.EditValue, this.e시작일자.DateTime, this.e종료일자.DateTime);
        }

        private void 모델선택_CustomDisplayText(object sender, DevExpress.XtraEditors.Controls.CustomDisplayTextEventArgs e)
        {
            try {
                모델구분 모델 = (모델구분)(sender as LookUpEdit).EditValue;
